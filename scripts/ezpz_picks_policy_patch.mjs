...
function patchRoute(text) {
  ...
  text = text.replaceAll("AI Pick", "EZPZ Pick");
  return text;
}

function patchPage(text) {
  text = renamePublicCopy(text);
  text = text.replaceAll('type Tab = "Today’s Best Plays" | "Today’s Trend Plays" | "EZPZ AI Picks" | "Full Slate" | "Records";', 'type Tab = "Today’s Best Plays" | "Today’s Trend Plays" | "EZPZ Picks" | "Full Slate" | "Records";');
  text = text.replaceAll('"EZPZ AI Picks"', '"EZPZ Picks"');
...
function patchNotifier(text) {
  ...
  text = text.replaceAll("AI Score ", "Qualification Score ");
  text = text.replaceAll("EZPZ AI Pick Final", "EZPZ Pick Final");
