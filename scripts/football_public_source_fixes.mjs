...
// The optimized NFL public layer is intentionally a thin wrapper. Keep these
// historical source-normalization fixes pointed at the preserved implementation
// when that module exists, while remaining compatible with older checkouts.
const path = fs.existsSync("lib/footballPublicDataLegacy.ts")
  ? "lib/footballPublicDataLegacy.ts"
