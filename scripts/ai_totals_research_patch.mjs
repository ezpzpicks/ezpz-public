...
QUESTION FOR AN UNDER: Have both starters shown enough recent and contextual run prevention to make a low-scoring game more likely? QUESTION FOR AN OVER: Is one or both starters showing enough recent or contextual vulnerability to make a high-scoring game more likely?
...
USE: verify each starter's LAST 3 STARTS. Record innings pitched, total runs allowed, earned runs allowed, hits, walks, home runs and pitch count when available. State the runs/earned runs allowed in each of the three starts rather than using vague labels such as "good recent form."
