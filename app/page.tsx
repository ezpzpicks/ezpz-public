      ...
      <>
        ...
        <div className="sectionHead dkSignalsHead">
          <div>
            ...
            <p>
              Tracks every saved game’s model-selected moneyline and total, including passes, with Qualified Plays available as a separate filter. Signals are evidence only until their sample becomes reliable.
            </p>
          </div>
        </div>
