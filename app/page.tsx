...
function PitcherPhoto({ url, summary }: { url?: string; summary: string }) {
  ...
  if (url) {
    return <img className="headshot" src={url} alt={`${name} headshot`} loading="lazy" />;
  }
      ...
      {kPlay ? (
        <>
          ...
          <div className="bubbleGrid">
            ...
            <MiniBubble
              label="Reliability"
              value={diagnostics.reliabilityText}
              green
            />
        ...
        <>
          ...
          <div className="bubbleGrid">
            ...
            <MiniBubble label="Grade" value={normalizeType(play.playType)} green />
          </div>
        </>
      ) : totalPlay ? (
        <>
          ...
          <div className="bubbleGrid">
            ...
            <MiniBubble label="Reliability" value={diagnostics.reliabilityText} green />
            <MiniBubble label="Odds" value={getPlayableOdds(play)} green />
            <MiniBubble label="EZPZ Score" value={rankScore || "—"} green />
          </div>
        </>
...
export default function Home() {
  ...
  const content = useMemo(() => {
    ...
    if (!data) return <div className="empty">Loading calibrated EZPZ projections…</div>;
  ...
  return (
    <main className="shell">
      <section className="hero">
        ...
        <p className="heroSub">
          Calibrated betting projections built from confirmed lineups, role-aware
          workloads, model probability, and projection reliability.
        </p>
        <div className="heroStatusRow">
          <span className="statusDot">●</span>
          <span>{activeModelVersion ? `MLB Model ${activeModelVersion}` : "MLB model online"}</span>
          {data?.lastUpdated ? <span>Updated {data.lastUpdated}</span> : null}
          <button
            type="button"
            className="refreshBtn"
            onClick={() => void loadData()}
            disabled={refreshing}
            aria-label="Refresh public projections"
          >
      ...
      <footer className="siteFooter">
        <div>
          ...
          <span>Calibrated projections • confirmed-lineup workflow • role-aware pitcher modeling</span>
        </div>
        <p>
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .hero {
          ...
          background:
            linear-gradient(135deg, rgba(15, 23, 42, 0.96), rgba(15, 37, 75, 0.82)),
            radial-gradient(circle at 85% 15%, rgba(34, 197, 94, 0.14), transparent 22rem);
        ...
        .miniBubble.green {
          background: linear-gradient(135deg, rgba(6, 78, 59, 0.32), rgba(15, 23, 42, 0.66));
        ...
        .marketPanel.green {
          ...
          background: linear-gradient(145deg, rgba(6, 78, 59, 0.2), rgba(15, 23, 42, 0.48));
        }
        .marketPanelTop {
          display: flex;
          align-items: center;
        ...
        .pitcherBox.green {
          ...
          background: linear-gradient(145deg, rgba(6, 78, 59, 0.18), rgba(2, 6, 23, 0.2));
        }
        .pitcherMetrics {
          margin-top: 12px;
          grid-template-columns: repeat(3, minmax(0, 1fr));
