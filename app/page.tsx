...
function passesMinimumScoreFilter(
  ...
  const isPitcherUnder =
    isKType(play.playType) && normalizedType.includes("UNDER");
...
function passesOverallRecordFilter(
  ...
  // Do not exclude Best Plays just because a bet type is losing overall.
  // The page already applies the important filters separately:
  // qualified green status, non-edge moneyline removal, odds cutoff,
  // score threshold, and cold-form protection.
  return true;
}
