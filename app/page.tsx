  ...
  return (
    <div className="dkRecordsCard trendTierRecordsCard">
      ...
      <div className="trendRecordsNote">
        {gradedCount
          ? `${filteredCount} completed official trend plays match these filters (${gradedCount} total available). Every result uses the exact Good / Strong / Elite tier and score saved in the final pregame snapshot. Nothing is re-graded after the game. Older games without an official final pregame grade are excluded.`
