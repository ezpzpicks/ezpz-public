...
function TrendPlayCard({
  ...
  return (
    <article className={`card fade-in best trendCard ${play.score >= 70 ? "top" : ""}`}>
      {badgeText ? (
        ...
        <section>
          <div className="sectionHead">
            <div>
              ...
              <p>
                Every current DraftKings moneyline, Over, and Under ranked by historical
                signal performance. Higher scores appear first; balanced or unproven markets
                remain visible near the middle instead of being filtered out.
              </p>
            </div>
