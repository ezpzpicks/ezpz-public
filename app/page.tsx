  ...
  return (
    <div className={`card green fade-in best ${index < 3 ? "top" : ""}`}>
      <div className="cardTop">
        ...
        <div className="scorePill" aria-label={`EZPZ Score ${score}`}>
          <span className="scorePillLabel">EZPZ</span>
          <strong>{score}</strong>
          <span className="scorePillSub">SCORE</span>
        </div>
      ...
      <section className="hero">
        ...
        <div className="heroBrand">
          ...
          <div className="heroCopy">
            <h1>Today’s calibrated betting board</h1>
            <p className="heroSub">
              Confirmed lineups, role-aware workloads, model probability, and
              projection reliability—presented in one clean slate.
            </p>
          </div>
        </div>
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .marketBubble {
          ...
          padding: 7px 10px;
          color: #c9f7db;
          background: rgba(20, 120, 65, 0.16);
          border: 1px solid rgba(43, 216, 117, 0.22);
          font-size: 10px;
          font-weight: 950;
          letter-spacing: 0.06em;
          text-transform: uppercase;
        ...
        .marketBubble {
          display: inline-flex;
          color: #dcecff;
          background: rgba(29, 104, 212, 0.14);
          border-color: rgba(71, 158, 248, 0.2);
        }
