...
function isBestPlay(play: Play) {
  return isQualifiedGreenPlay(play) && passesBestPlayOdds(play);
}
      ...
      {kPlay ? (
        <>
          ...
          <div className="bubbleGrid">
            ...
            <MiniBubble label="6-Inning" value={play.sixInningKs || "—"} green />
            <MiniBubble label="Volatility" value={play.volatility || "—"} green />
          </div>
        </>
      ) : moneylinePlay ? (
        <>
          ...
          <div className="projectionBlock">
            <div className="projection">{play.moneylinePct || play.score || "—"}</div>
          ...
          <div className="bubbleGrid">
            <MiniBubble label="Odds" value={formatOdds(play.oddsLine || "—")} green />
            <MiniBubble label="Model %" value={play.moneylinePct || play.score || "—"} green />
