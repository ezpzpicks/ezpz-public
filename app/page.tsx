...
.logoWrap {
  width: 124px; height: 124px; margin: 0 auto 15px; display: grid; place-items: center; border-radius: 999px;
  background:
...
.logo { width: 88px; height: 88px; object-fit: contain; border-radius: 999px; position:relative; z-index:2; filter: drop-shadow(0 10px 18px rgba(0,0,0,.36)); }
.logoFallback { position:absolute; font-size:30px; font-weight:950; letter-spacing:-2px; color:#dbeafe; z-index:1; }
h1 {
  margin: 0;
...
@media (max-width: 760px) {
  ...
  .logoWrap { width:104px; height:104px; }
