        ...
        <>
          <div className="sectionHead">
            <div>
              ...
              <p>Your final conviction card selected from today’s Best Plays. Last updated: {data.lastUpdated}</p>
            </div>
          </div>

          {handpickedPlays.length ? (
            <div className="cards handpickedGrid">
            ...
            <div className="empty">No handpicked plays marked yet for {data.today}.</div>
          )}
