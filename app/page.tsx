...
.versionPill { display:inline-flex; margin-top:8px; padding:5px 9px; border-radius:999px; background:rgba(148,163,184,.12); color:#93c5fd; font-size:.68rem; font-weight:950; letter-spacing:.06em; }
...
const BUILD_VERSION = "v9-tracker-best-plays";
        ...
        <>
          <div className="sectionHead">
            <div>
              ...
              <p>
                Best Plays are today's pending tracker bets whose bet type is winning over the last 7 days.
  ...
  return (
    <main className="shell">
      ...
      <section className="hero">
        ...
        <div className="versionPill">BUILD {BUILD_VERSION}</div>
      </section>
