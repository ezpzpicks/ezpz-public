    ...
    <div className="dkRecordsCard">
      <div className="dkRecordFilters">
        ...
        <label>
          ...
          <select value={scope} onChange={(event) => setScope(event.target.value as "Qualified" | "All")}>
            ...
            <option value="All">All Tracked Plays</option>
          </select>
        </label>
        <label>
          <span>Side</span>
      ...
      {summaries.length ? (
        ...
        <div className="empty insideSignalRecords">
          No completed moneyline or total plays match these filters yet. Records will populate automatically as tracked games finish.
        </div>
      )}
    </div>
  );
      ...
      <>
        ...
        <div className="sectionHead dkSignalsHead">
          <div>
            ...
            <p>
              Tracks the record and ROI of each public-split classification and meaningful line-movement overlay. Signals are evidence only until their sample becomes reliable.
            </p>
          </div>
        </div>
