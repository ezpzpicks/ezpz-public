...
function PublicBettingPanel({ info }: { info: PublicBettingInfo | null }) {
  ...
  return (
    <div className="publicSplitPanel">
      ...
      <div className="bubbleGrid publicSplitGrid">
        <MiniBubble label="Public %" value={publicPctText(info.betsPct)} />
        <MiniBubble label="Sharp %" value={publicPctText(info.moneyPct)} />
        <MiniBubble
          label="Sharp − Public"
          value={
            info.gapPct == null
          ...
          return (
            <div className="liveSplitEntry" key={`${split.market}-${split.selection}`}>
              <div className="liveSplitRow">
                ...
                <span><small>Public</small>{publicPctText(split.betsPct)}</span>
    ...
    >
      ...
      <div className="trendSelectionBody">
        ...
        <div className="bubbleGrid trendSelectionMetrics">
          <MiniBubble label="Public %" value={publicPctText(play.betsPct)} />
          <MiniBubble label="Sharp %" value={publicPctText(play.moneyPct)} />
          <MiniBubble
            label="Sharp − Public"
