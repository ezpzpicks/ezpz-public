...
export async function buildFootballPublicData(
  ...
  // NFL Trend V2 remains research-only. Public Fade and Strong RLM are
  // converted into official Trend EZPZ Picks in footballPublicDataHistory.ts.
  const trendPicks: NflEzpzPick[] = [];
  const aiPicks = dedupeEzpzPicks(modelPicks);
